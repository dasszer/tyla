...
class Bouncer{
    // FIXME-begin
    static void check_not_null(Integer a, String variable)
    {
        if (a == null)
            throw new IllegalArgumentException(variable + " is null");
    }
    static void check_negative(Integer a, String variable)
    {
        if (a >= 0)
            throw new IllegalArgumentException(variable + " is positive");
    }
    static void check_positive(Integer a, String variable)
    {
        if (a < 0)
            throw new IllegalArgumentException(variable + " is negative");
    }
    // FIXME-end
}
